...
function draw() {
  ...
  textStyle('algerian');
  textSize(100);
  text("Newton's Cradle",30,height-100);
  textSize(18);
  text("It's a simulation of Newton's Cradle which illustrates the transfer of momentum between bodies.",15,height-50);
  text("This model was invented by Sir Isaac Newton",200,height-20);
